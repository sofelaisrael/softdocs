...
export default function Home() {
  useEffect(() => {
    ...
    const cardHandlers = new Map<Element, (e: Event) => void>();
    ...
    document.querySelectorAll("[data-hero-version]").forEach((btn) => {
      btn.addEventListener("click", () => {
        document.querySelectorAll("[data-hero-version]").forEach((b) => {
        ...
        <div className="paper-grid">
          <div className="container">
            <div className="hero-section" style={{ border: "none" }}>
              ...
              {/* Code card */}
              <div className="hero-code-card-wrap animate-in animate-delay-2">
                  ...
                  <div className="hero-code-header">
                    <div className="hero-code-header-left">
                      <div className="hero-dots">
                        <span
                          className="hero-dot"
                          style={{ background: "#e8b59e" }}
                        />
                        <span
                          className="hero-dot"
                          style={{ background: "#dec98d" }}
                        />
                        <span
                          className="hero-dot"
                          style={{ background: "#9bc49b" }}
                        />
                      </div>
                      <span
                    ...
                    <div className="flex items-center gap-1.5 text-[12px]">
                      {["3.2", "3.1", "2.8"].map((v) => (
                        <button
                          key={v}
                          data-hero-version={v}
                          className={`hero-ver-btn${v === "3.2" ? " active" : ""}`}
                        >
                          v{v}
                        </button>
                      ))}
  ...
  <span class="prop">theme</span>: {
    ...
    <span class="prop">versioning</span>: <span class="str">&apos;frozen&apos;</span>
                ...
                <div className="hero-badge-left">
                  <div className="hero-badge-label">Build time</div>
                  <div className="hero-badge-value">1.4s &bull; 284 pages</div>
                </div>
                <div className="hero-badge-right">
                  <div className="hero-badge-label">Search index</div>
                  <div className="hero-badge-value">
                    12ms &bull; offline-first
                  </div>
                </div>
              </div>
